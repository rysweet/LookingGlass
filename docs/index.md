...
- [[PLANNED] Score and time workflow usage](./score-time-workflow-usage.md)
...
| IDE workflows | Supports editing, running, and curriculum tasks | [IDE operations](./ide-operations.md), [Grading pipeline](./grading-pipeline.md), [[PLANNED] Score and time workflow usage](./score-time-workflow-usage.md), [[PLANNED] Score and time workflow API](./score-time-workflow-api.md) |
...
- [[PLANNED] Tutorial: add score and time to an Alice world](./tutorial-score-time-workflow.md)
...
- [[PLANNED] Score and time workflow API](./score-time-workflow-api.md)
- [[PLANNED] Score and time workflow configuration](./score-time-workflow-configuration.md)
